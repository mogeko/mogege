...
!function(e) {
  ...
  var f = [], i = Object.keys, _ = {}, c = {}, C = !0,
      n = /^(no-?highlight|plain|text)$/i, l = /\blang(?:uage)?-([\w-]+)\b/i,
      t = /((^(<[^>]+>|\t|)+|(?:\n)))/gm, r = {
        case_insensitive : "cI",
        lexemes : "l",
        contains : "c",
  ...
  function g(e) { return e.nodeName.toLowerCase() }
  function u(e) { return n.test(e) }
  function s(e) {
  ...
  function R(n) {
    return n.v && !n.cached_variants &&
               (n.cached_variants =
                    n.v.map(function(e) { return s(n, {v : null}, e) })),
           n.cached_variants
               ? n.cached_variants
               : function e(n) { return !!n && (n.eW || e(n.starts)) }(n)
  ...
  function v(n, r) {
    var a = {};
    return "string" == typeof n ? t("keyword", n)
                                : i(n).forEach(function(e) { t(e, n[e]) }),
           a;
    function t(t, e) {
      r && (e = e.toLowerCase()), e.split(" ").forEach(function(e) {
        ...
        a[n[0]] = [
          ...
          function(e, n) {
            return n ? Number(n)
                     : function(e) { return -1 != o.indexOf(e.toLowerCase()) }(
                           e)
                           ? 0
                           : 1
          }(n[0], n[1])
  ...
  function S(r) {
    ...
    function a(a) {
      ...
      var u = c.map(function(e) { return e[1] });
      return i = f(function(e, n) {
        ...
        return "string" == typeof n ? (t.type = n, t.extra = [ a.i, a.tE ])
    ...
    if (r.c && -1 != r.c.indexOf("self")) {
      ...
      r.c = r.c.filter(function(e) { return "self" != e })
    }
    !function n(t, e) {
      t.compiled ||
          (t.compiled = !0, t.k = t.k || t.bK, t.k && (t.k = v(t.k, r.cI)),
           t.lR = f(t.l || /\w+/, !0),
           e &&
               (t.bK && (t.b = "\\b(" + t.bK.split(" ").join("|") + ")\\b"),
                t.b || (t.b = /\B|\b/), t.bR = f(t.b),
                t.endSameAsBegin && (t.e = t.b), t.e || t.eW || (t.e = /\B|\b/),
                t.e && (t.eR = f(t.e)), t.tE = s(t.e) || "",
                t.eW && e.tE && (t.tE += (t.e ? "|" : "") + e.tE)),
           t.i && (t.iR = f(t.i)), null == t.relevance && (t.relevance = 1),
           t.c || (t.c = []),
           t.c = Array.prototype.concat.apply(
               [], t.c.map(function(e) { return R("self" === e ? t : e) })),
  ...
  function T(n, e, a, t) {
    ...
    function l() {
      p += null != d.sL ? function() {
        ...
        return 0 < d.relevance && (M += n.relevance), e && (R[d.sL] = n.top),
        ...
        for (r = "", n = 0, d.lR.lastIndex = 0, t = d.lR.exec(v); t;)
          r += x(v.substring(n, t.index)),
              a = d, i = t, void 0, o = g.cI ? i[0].toLowerCase() : i[0],
              (e = a.k.hasOwnProperty(o) && a.k[o])
                  ? (M += e[1], r += c(e[0], x(t[0])))
                  : r += x(t[0]),
              n = d.lR.lastIndex, t = d.lR.exec(v);
    ...
    function r(e, n) {
      ...
      if (v += e, null == t)
        return l(), 0;
      if ("begin" == f.type && "end" == n.type && f.index == n.index &&
          "" === t)
        ...
        var r = function(e) {
          ...
          if (r) {
            ...
            for (a.skip ? v += n
                 ...
                 d.cN && (p += m), d.skip || d.sL || (M += d.relevance),
                 (d = d.parent) !== r.parent;)
              ;
            return r.starts &&
  ...
  function w(t, e) {
    ...
    return e.filter(D).filter(L).forEach(function(e) {
      var n = T(e, t, !1);
      n.language = e, n.relevance > a.relevance && (a = n),
  ...
  function M(e) {
    return B.tabReplace || B.useBR ? e.replace(t, function(e, n) {
      return B.useBR && "\n" === e
                 ? "<br>"
                 : B.tabReplace ? n.replace(/\t/g, B.tabReplace) : ""
    }) : e
  }
  function b(e) {
    var n, t, r, a, i, o = function(e) {
      ...
      if (i += e.parentNode ? e.parentNode.className : "", t = l.exec(i)) {
        var o = D(t[1]);
        return o || (console.warn(O.replace("{}", t[1])),
                     console.warn(
    ...
    u(o) || (B.useBR ? (n = document.createElement("div")).innerHTML =
                           e.innerHTML.replace(/\n/g, "").replace(/<br[ \/]*>/g,
                                                                  "\n")
                     : n = e,
             i = n.textContent, r = o ? T(o, i, !0) : w(i),
             (t = E(n)).length &&
                 ((a = document.createElement("div")).innerHTML = r.value,
                  r.value = d(t, E(a), i)),
             r.value = M(r.value), e.innerHTML = r.value,
             e.className =
                 function(e, n, t) {
  ...
  function D(e) { return e = (e || "").toLowerCase(), _[e] || _[c[e]] }
  function L(e) {
    var n = D(e);
    return n && !n.disableAutodetect
  }
  return a.highlight = T, a.highlightAuto = w, a.fixMarkup = M,
         a.highlightBlock = b, a.configure = function(e) { B = s(B, e) },
         ...
         a.registerLanguage =
           ...
           p(_[n] = t), t.rawDefinition = e.bind(null, a),
                        t.aliases && t.aliases.forEach(function(e) { c[e] = n })
         },
         a.listLanguages = function() { return i(_) }, a.getLanguage = D,
         a.requireLanguage =
             function(e) {
           var n = D(e);
           if (n)
         ...
         a.autoDetection = L, a.inherit = s,
         a.debugMode = function() { C = !1 },
         ...
         a.BNM =
             a.BINARY_NUMBER_MODE = {cN : "number", b : a.BNR, relevance : 0},
         ...
         a.UTM =
             a.UNDERSCORE_TITLE_MODE = {cN : "title", b : a.UIR, relevance : 0},
         a.METHOD_GUARD = {b : "\\.\\s*" + a.UIR, relevance : 0},
         [
           a.BE, a.ASM, a.QSM, a.PWM, a.C, a.CLCM, a.CBCM, a.HCM, a.NM, a.CNM,
           a.BNM, a.CSSNM, a.RM, a.TM, a.UTM, a.METHOD_GUARD
         ].forEach(function(e) {
           !function n(t) {
             Object.freeze(t);
...
hljs.registerLanguage("swift", function(e) {
  ...
  return n.c = [ a ], {
    k: i, c: [
      ...
      {cN : "type", b : "\\b[A-Z][\\wÀ-ʸ']*", relevance : 0}, a, {
        cN : "function",
        bK : "func",
        e : "{",
        eE : !0,
...
hljs.registerLanguage("less", function(e) {
  ...
  n.push(e.CLCM, e.CBCM, r("'"), r('"'), e.CSSNM, {
    ...
    starts : {cN : "string", e : "[\\)\\n]", eE : !0}
         ...
         t("number", "#[0-9A-Fa-f]+\\b"), b, t("variable", "@@?" + a, 10),
         t("variable", "@{" + a + "}"), t("built_in", "~?`[^`]*?`"),
         {cN : "attribute", b : a + "\\s*:", e : ":", rB : !0, eE : !0},
         {cN : "meta", b : "!important"});
  var i = n.concat({b : "{", e : "}", c : s}),
      l = {bK : "when", eW : !0, c : [ {bK : "and not"} ].concat(n)}, o = {
        b : c + "\\s*:",
        rB : !0,
        e : "[;}]",
        relevance : 0,
      ...
      C = {
        ...
        relevance : 0,
        c : [
          e.CLCM, e.CBCM, l, t("keyword", "all\\b"),
          t("variable", "@{" + a + "}"), t("selector-tag", c + "%?", 0),
          t("selector-id", "#" + c), t("selector-class", "\\." + c, 0),
          t("selector-tag", "&", 0),
...
hljs.registerLanguage("ruby", function(e) {
  var c = "[a-zA-Z_]\\w*[!?=]?|[-+~]\\@|<<|>>|=~|===?|<=>|[<>]=?|\\*\\*|[-/+%^&*~`|]|\\[\\]=?",
      ...
      i = {cN : "params", b : "\\(", e : "\\)", endsParent : !0, k : b}, l = [
        t, a, {
          cN : "class",
          bK : "class module",
          e : "$|;",
  ...
  return {
    aliases: [ "rb", "gemspec", "podspec", "thor", "irb" ], k: b, i: /\/\*/,
        c: n.concat(d).concat(l)
  }
});
hljs.registerLanguage("lua", function(e) {
  var t = "\\[=*\\[", a = "\\]=*\\]", n = {b : t, e : a, c : [ "self" ]}, l = [
    e.C("--(?!" + t + ")", "$"), e.C("--" + t, a, {c : [ n ], relevance : 10})
  ];
  return {
    l: e.UIR, k: {
      literal: "true false nil",
...
hljs.registerLanguage("yaml", function(e) {
  ...
  return {
    cI: !0, aliases: [ "yml", "YAML", "yaml" ], c: [
      ...
      {cN : "meta", b : "&" + e.UIR + "$"},
      {cN : "meta", b : "\\*" + e.UIR + "$"},
      {cN : "bullet", b : "\\-(?=[ ]|$)", relevance : 0}, e.HCM,
      {bK : b, k : {literal : b}}, {cN : "number", b : e.CNR + "\\b"}, a
    ]
  }
});
...
hljs.registerLanguage("kotlin", function(e) {
  ...
  return d.v[1].c = [ o ], o.v[1].c = [ d ], {
    aliases: [ "kt" ], k: t, c: [
      e.C("/\\*\\*", "\\*/",
          {relevance : 0, c : [ {cN : "doctag", b : "@[A-Za-z]+"} ]}),
      e.CLCM, b, {
        cN : "keyword",
...
hljs.registerLanguage("javascript", function(e) {
  var r = "<>", a = "</>",
      ...
      s = {
        cN : "number",
        v : [
          {b : "\\b(0[bB][01]+)n?"}, {b : "\\b(0[oO][0-7]+)n?"},
          {b : e.CNR + "n?"}
        ],
        relevance : 0
      },
      o = {cN : "subst", b : "\\$\\{", e : "\\}", k : n, c : []}, i = {
        b : "html`",
        e : "",
  ...
  return {
    aliases: [ "js", "jsx", "mjs", "cjs" ], k: n,
        c:
            [
              {cN : "meta", relevance : 10, b : /^\s*['"]use (strict|asm)['"]/},
              {cN : "meta", b : /^#!/, e : /$/}, e.ASM, e.QSM, i, b, l, e.CLCM,
              e.C("/\\*\\*", "\\*/", {
                relevance : 0,
                c : [ {
                  cN : "doctag",
...
hljs.registerLanguage("go", function(e) {
  ...
  return {
    aliases: [ "golang" ], k: n, i: "</", c: [
      e.CLCM, e.CBCM, {cN : "string", v : [ e.QSM, e.ASM, {b : "`", e : "`"} ]},
...
hljs.registerLanguage("cpp", function(e) {
  ...
  return {
    aliases: [ "c", "cc", "h", "c++", "h++", "hpp", "hh", "hxx", "cxx" ], k: p,
        i: "</",
        c: [].concat(
            d, b, m,
            [
    ...
    v : [ {b : /\$\d+/}, {b : /\$\{/, e : /}/}, {b : "[\\$\\@]" + e.UIR} ]
      ...
      b = {
        ...
        c : [
          ...
          {cN : "number", b : "\\b\\d+[kKmMgGdshdwy]*\\b", relevance : 0}, r
        ]
      };
  return {
    aliases: [ "nginxconf" ],
...
hljs.registerLanguage("xml", function(e) {
  var c = {cN : "symbol", b : "&[a-z]+;|&#[0-9]+;|&#x[a-f0-9]+;"}, s = {
    b : "\\s",
        ...
        cI: !0, c: [
          {
            ...
            c : [
              s, l, t, a, {
                ...
                e : "\\]",
                c : [
                  {cN : "meta", b : "<![a-z]", e : ">", c : [ s, a, l, t ]}
                ]
              }
            ]
          },
          e.C("\x3c!--", "--\x3e", {relevance : 10}),
          {b : "<\\!\\[CDATA\\[", e : "\\]\\]>", relevance : 10}, c,
    ...
    literal : "False None True"
      ...
      a = {b : /\{\{/, relevance : 0}, l = {
        ...
        v : [
          ...
          {b : /(u|r|ur)"/, e : /"/, relevance : 10}, {b : /(b|br)'/, e : /'/},
          {b : /(b|br)"/, e : /"/},
          {b : /(fr|rf|f)'/, e : /'/, c : [ e.BE, a, c ]},
          {b : /(fr|rf|f)"/, e : /"/, c : [ e.BE, a, c ]}, e.ASM, e.QSM
        ]
      },
      n = {
        cN : "number",
...
hljs.registerLanguage("json", function(e) {
  var i = {literal : "true false null"}, n = [ e.CLCM, e.CBCM ],
      c = [ e.QSM, e.CNM ], r = {e : ",", eW : !0, eE : !0, c : c, k : i}, t = {
        b : "{",
        e : "}",
        c : [
  ...
  return c.push(t, a), n.forEach(function(e) { c.push(e) }), {
    c: c, k: i, i: "\\S"
  }
});
...
hljs.registerLanguage("cs", function(e) {
  ...
  return {
    aliases: [ "csharp", "c#" ], k: a, i: /::/, c: [
      e.C("///", "$", {
        rB : !0,
        c : [ {
          cN : "doctag",
          v : [
            {b : "///", relevance : 0}, {b : "\x3c!--|--\x3e"},
            {b : "</?", e : ">"}
          ]
        } ]
      }),
...
hljs.registerLanguage("powershell", function(e) {
  var t = {
    keyword :
      ...
      n = {b : "`[\\s\\S]", relevance : 0}, c = {
        cN : "variable",
        v : [
          {b : /\$\B/}, {cN : "keyword", b : /\$this/},
          {b : /\$[\w\d][\w\d_:]*/}
        ]
      },
      i = {
      ...
      m = {
        ...
        c : [].concat("self", u, {
          b : "(" +
                  [
                    "string", "char", "byte", "int", "long", "bool", "decimal",
                    "single", "double", "DateTime", "xml", "array", "hashtable",
                    "void"
                  ].join("|") +
                  ")",
          cN : "built_in",
  ...
  return d.c.unshift(m), {
    aliases: [ "ps", "ps1" ], l: /-?[A-z\.\-]+/, cI: !0, k: t,
...
hljs.registerLanguage("typescript", function(e) {
  ...
  return o.c = [ e.ASM, e.QSM, i, l, b, s, e.RM ], {
    aliases: [ "ts" ], k: t, c: [
      {cN : "meta", b : /^\s*['"]use strict['"]/}, e.ASM, e.QSM, i, l, b,
      e.CLCM, e.CBCM, s, {
        b : "(" + e.RSR + "|\\b(case|return|throw)\\b)\\s*",
        k : "return throw case",
        c : [
...
hljs.registerLanguage("coffeescript", function(e) {
  var c = {
    ...
    built_in : "npm require console print module global window document"
      ...
      r = {cN : "subst", b : /#\{/, e : /}/, k : c}, i = [
        e.BNM, e.inherit(e.CNM, {starts : {e : "(\\s*/)?", relevance : 0}}), {
          cN : "string",
          v : [
            {b : /'''/, e : /'''/, c : [ e.BE ]},
            {b : /'/, e : /'/, c : [ e.BE ]},
  ...
  r.c = i;
  var s = e.inherit(e.TM, {b : n}), t = "(\\(.*\\))?\\s*\\B[-=]>", a = {
    cN : "params",
    b : "\\([^\\(]",
    rB : !0,
