  ...
  var a = Object.freeze({
    ...
    mergeStreams : function(e, t, a) {
      ...
      for (; e.length || t.length;) {
        var g = l();
        if (((s += n(a.substring(i, g[0].offset))), (i = g[0].offset),
             g === e)) {
          o.reverse().forEach(u);
          do {
  ...
  return (function(n) {
    ...
    function p(e, n, r, i) {
      ...
      function c() {
        null != _.subLanguage
            ? (function() {
                if ("" !== k) {
                  ...
                  if (!e || a[_.subLanguage]) {
                    var n =
                        e ? p(_.subLanguage, k, !0, E[_.subLanguage])
            ...
            : (function() {
                var e, n, t, r;
                if (_.keywords) {
                  for (n = 0, _.lexemesRe.lastIndex = 0,
                      t = _.lexemesRe.exec(k), r = "";
                       t;

                  ) {
                    r += k.substring(n, t.index);
                    var a = null;
                    (e = l(_, t)) ? (w.addText(r), (r = ""), (T += e[1]),
                                     (a = e[0]), w.addKeyword(t[0], a))
                                  : (r += t[0]),
        ...
        if (((f = t), "begin" === t.type))
          return (function(e) {
            ...
            return t.__onBegin && (t.__onBegin(e) || {}).ignoreMatch
                       ? (function(e) {
                           return 0 === _.matcher.regexIndex ? ((k += e[0]), 1)
                                                             : ((B = !0), 0);
                         })(n)
                       : (t && t.endSameAsBegin &&
                              (t.endRe = RegExp(
                                   ...
                                   "m")),
                          t.skip ? (k += n)
                                 : (t.excludeBegin && (k += n), c(),
                                    t.returnBegin || t.excludeBegin || (k = n)),
                          h(t), t.returnBegin ? 0 : n.length);
          })(t);
        if ("illegal" === t.type && !r)
      ...
      !(function(e) {
        ...
        class a {
          ...
          exec(e) {
            ...
            let t = n.exec(e);
            return (
                t && ((this.regexIndex += t.position + 1),
          ...
          s.compiled ||
              ((s.compiled = !0), (s.__onBegin = null),
               ...
               (s.contains = [].concat(...s.contains.map(function(e) {
                 return (function(e) {
                   return (
                       e.variants && !e.cached_variants &&
                           (e.cached_variants = e.variants.map(function(
                                n) { return t(e, {variants : null}, n); })),
                       e.cached_variants
                           ? e.cached_variants
                           : (function e(n) {
      ...
      try {
        for (_.matcher.considerAll();
             A++,
             B ? (B = !1)
               : ((_.matcher.lastIndex = L), _.matcher.considerAll()),
             (y = _.matcher.exec(s));

        )
          (O = b(s.substring(L, y.index), y)), (L = y.index + O);
        return (b(s.substr(L)), w.closeAllNodes(), w.finalize(),
                (x = w.toHTML()), {
                  relevance : T,
                  value : x,
                  language : e,
    ...
    function b(e) {
      return g.tabReplace || g.useBR ? e.replace(l, function(e, n) {
        return g.useBR && "\n" === e
                   ? "<br>"
                   : g.tabReplace ? n.replace(/\t/g, g.tabReplace) : "";
      }) : e;
    }
    function v(e) {
      var n, t, r, a, s,
      ...
      h(o) || (T("before:highlightBlock", {block : e, language : o}),
               g.useBR ? ((n = document.createElement("div")).innerHTML =
                              e.innerHTML.replace(/\n/g, "").replace(
                                  /<br[ \/]*>/g, "\n"))
                       : (n = e),
    ...
    Object.assign(n, {
      ...
      registerLanguage : function(e, t) {
        ...
        r.name || (r.name = e), (a[e] = r), (r.rawDefinition = t.bind(null, n)),
      ...
      addPlugin : function(e, n) { s.push(e); },
        ...
        (n.debugMode = function() { o = !1; }),
        (n.safeMode = function() { o = !0; }), (n.versionString = "10.0.3");
    for (const n in _)
        ...
        var n = {
          ...
          literal : "null false true",
            ...
            r = e.inherit(l, {illegal : /\n/}), c = {
              ...
              illegal : /\n/,
              contains :
                  [ {begin : "{{"}, {begin : "}}"}, e.BACKSLASH_ESCAPE, r ],
            },
            o = {
              className : "string",
              begin : /\$@"/,
...
hljs.registerLanguage(
    "c-like", (function() {
      ...
      return function(e) {
        ...
        var n = "(decltype\\(auto\\)|" + t("[a-zA-Z_]\\w*::") +
                "[a-zA-Z_]\\w*" + t("<.*?>") + ")",
      ...
      return function(e) {
        ...
        var r = {
          ...
          begin :
            ...
            d = o;
        return (
            (d.variants[1].contains = [ o ]), (o.variants[1].contains = [ d ]),
            {
              name : "Kotlin",
              aliases : [ "kt" ],
              keywords : n,
        ...
        var n = "[a-zA-Z_]\\w*[!?=]?|[-+~]\\@|<<|>>|=~|===?|<=>|[<>]=?|\\*\\*|[-/+%^&*~`|]|\\[\\]=?",
            ...
            d = [
              ...
              },
              {
                ...
                contains :
                    [ e.inherit(e.TITLE_MODE, {begin : n}), b ].concat(r),
              },
              {begin : e.IDENT_RE + "::"},
              {
                className : "symbol",
    ...
    "less", (function() {
      ...
      return function(e) {
        ...
        s.push(e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE, t("'"), t('"'),
               ...
               r("number", "#[0-9A-Fa-f]+\\b"), i,
               r("variable", "@@?[\\w-]+", 10), r("variable", "@{[\\w-]+}"),
               r("built_in", "~?`[^`]*?`"), {
                 className : "attribute",
                 begin : "[\\w-]+\\s*:",
                 end : ":",
        ...
        var c = s.concat({begin : "{", end : "}", contains : a}), l = {
          ...
          contains : [ {beginKeywords : "and not"} ].concat(s),
            ...
            g = {
              ...
              starts :
                  {end : "[;{}]", returnEnd : !0, contains : s, relevance : 0},
            },
            d = {
              className : "variable",
              variants : [
        ...
        return {
          ...
          contains : [
            ...
            e.METHOD_GUARD,
            {
              ...
              illegal : /[:"\[\]]/,
              contains :
                  [ {beginKeywords : "extends"}, e.UNDERSCORE_TITLE_MODE ],
            },
