...
var hljs = function() {
  ...
  var a = Object.freeze({
    ...
    mergeStreams : function(e, t, a) {
      var i = 0, s = "", o = [];
      function l() {
        return e.length && t.length ? e[0].offset !== t[0].offset
  ...
  class l {
    ...
    static _collapse(e) {
      e.children && (e.children.every(e => "string" == typeof e)
                         ? (e.text = e.children.join(""), delete e.children)
                         : e.children.forEach(
                               e => {"string" != typeof e && l._collapse(e)}))
    }
  }
  class c extends l {
  ...
  const d =
      "(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)",
        ...
        m = function(e, n, r) {
          var a = t({className : "comment", begin : e, end : n, contains : []},
                    r || {});
  ...
  var _ = Object.freeze({
    ...
    BINARY_NUMBER_MODE :
        {className : "number", begin : "\\b(0b[01]+)", relevance : 0},
    CSS_NUMBER_MODE : {
      className : "number",
      begin :
    ...
    REGEXP_MODE : {
      ...
      contains : [ {
        ...
        illegal : /\n/,
        contains :
            [ g, {begin : /\[/, end : /\]/, relevance : 0, contains : [ g ]} ]
      } ]
    },
  ...
  return function(n) {
    ...
    function h(e) { return g.noHighlightRe.test(e) }
    function f(e, n, t, r) {
    ...
    function p(e, n, r, i) {
        ...
        null != _.subLanguage ? function() {
          if ("" !== k) {
            ...
            if (!e || a[_.subLanguage]) {
              var n = e ? p(_.subLanguage, k, !0, E[_.subLanguage])
          ...
          var e, n, t, r;
          if (_.keywords) {
            for (n = 0, _.lexemesRe.lastIndex = 0, t = _.lexemesRe.exec(k),
                r = "";
                 t;) {
              r += k.substring(n, t.index);
              var a = null;
              (e = l(_, t)) ? (w.addText(r), r = "", T += e[1], a = e[0],
                               w.addKeyword(t[0], a))
                            : r += t[0],
                  n = _.lexemesRe.lastIndex, t = _.lexemesRe.exec(k)
            }
      ...
      function b(n, t) {
        ...
        if (k += n, null == i)
          return c(), 0;
        if ("begin" == f.type && "end" == t.type && f.index == t.index &&
            "" === i) {
        ...
        if ("illegal" === t.type && !r)
          throw (a = Error('Illegal lexeme "' + i + '" for mode "' +
                           (_.className || "<unnamed>") + '"'))
              .mode = _,
         a;
        if ("end" === t.type) {
          var l = function(e) {
            ...
            if (r) {
              var a = _;
              a.skip ? k += n
                     : (a.returnEnd || a.excludeEnd || (k += n), c(),
                        a.excludeEnd && (k = n));
              do {
                _.className && w.closeNode(),
                    _.skip || _.subLanguage || (T += _.relevance), _ = _.parent
              } while (_ !== r.parent);
              return r.starts &&
      ...
      !function(e) {
        ...
        class r {
          constructor() {
            this.matchIndexes = {}, this.regexes = [], this.matchAt = 1,
            this.position = 0
          }
          addRule(e, n) {
            n.position = this.position++, this.matchIndexes[this.matchAt] = n,
            this.regexes.push([ n, e ]), this.matchAt += function(e) {
        ...
        class a {
          constructor() {
            this.rules = [], this.multiRegexes = [], this.count = 0,
            this.lastIndex = 0, this.regexIndex = 0
          }
          getMatcher(e) {
              ...
              (s.compiled = !0, s.__onBegin = null,
               ...
               o && (s.beginKeywords &&
                         (s.begin = "\\b(" +
                                    ...
                                    ")(?=\\b|\\s)",
                          s.__onBegin = i),
                     s.begin || (s.begin = /\B|\b/), s.beginRe = n(s.begin),
               ...
               s.contains = [].concat(...s.contains.map((function(e) {
                 return function(e) {
                   return e.variants&&!e.cached_variants&&(e.cached_variants=e.variants.map((function(n){return t(e,{variants:null},n)}))),e.cached_variants?e.cached_variants:function e(n){return!!n&&(n.endsWithParent||e(n.starts))}(e)?t(e,{starts:e.starts?t(e.starts):null}):Object.isFrozen(e)?t(e):e
                 }("self" === e ? s : e)
               }))),
               s.contains.forEach((function(e) { r(e, s) })),
    ...
    function m(e, n) {
      ...
      return n.filter(M).filter(k).forEach((function(n) {
        var a = p(n, e, !1);
        a.language = n, a.relevance > r.relevance && (r = a),
          ...
          (T("before:highlightBlock", {block : e, language : o}),
           g.useBR
               ? (n = document.createElement("div")).innerHTML =
                     e.innerHTML.replace(/\n/g, "").replace(/<br[ \/]*>/g, "\n")
               : n = e,
           s = n.textContent, r = o ? f(o, s, !0) : m(s),
           (t = y(n)).length &&
    ...
    function M(e) { return e = (e || "").toLowerCase(), a[e] || a[i[e]] }
    function k(e) {
      var n = M(e);
    ...
    function T(e, n) {
      var t = e;
      s.forEach((function(e) { e[t] && e[t](n) }))
    }
    Object.assign(n, {
      highlight : f,
      highlightAuto : m,
      fixMarkup : b,
      highlightBlock : v,
      configure : function(e) { g = w(g, e) },
      initHighlighting : x,
      initHighlightingOnLoad :
          function() { window.addEventListener("DOMContentLoaded", x, !1) },
      registerLanguage : function(e, t) {
        ...
        r.name || (r.name = e),
            a[e] = r, r.rawDefinition = t.bind(null, n),
            r.aliases && r.aliases.forEach((function(n) { i[n] = e }))
      },
      ...
      autoDetection : k,
      inherit : w,
      addPlugin : function(e, n) { s.push(e) }
    }),
        n.debugMode = function() { o = !1 }, n.safeMode = function() { o = !0 },
...
hljs.registerLanguage("csharp", function() {
  ...
  return function(e) {
    ...
    l.contains =
        [
          o, c, s, e.APOS_STRING_MODE, e.QUOTE_STRING_MODE, a,
          e.C_BLOCK_COMMENT_MODE
        ],
    r.contains = [
      g, c, t, e.APOS_STRING_MODE, e.QUOTE_STRING_MODE, a,
    ...
    return {
      name: "C#", aliases: [ "cs", "c#" ], keywords: n, illegal: /::/, contains: [
        e.COMMENT("///", "$", {
          returnBegin : !0,
          contains : [ {
            className :
                "doctag",
            variants : [
              {begin : "///", relevance : 0}, {begin : "\x3c!--|--\x3e"},
              {begin : "</?", end : ">"}
            ]
          } ]
        }),
...
hljs.registerLanguage("java", function() {
  ...
  return function(e) {
    ...
    return {
      name: "Java", aliases: [ "jsp" ], keywords: a, illegal: /<\/|#/, contains: [
        e.COMMENT("/\\*\\*", "\\*/", {
          relevance : 0,
          contains : [
            {begin : /\w+@/, relevance : 0},
        ...
        e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE, e.APOS_STRING_MODE,
        e.QUOTE_STRING_MODE, {
          className : "class",
          beginKeywords : "class interface",
          end : /[{;=]/,
        ...
        {beginKeywords : "new throw return else", relevance : 0}, {
          ...
          contains : [
            ...
            },
            {
              ...
              relevance : 0,
              contains : [
                n, e.APOS_STRING_MODE, e.QUOTE_STRING_MODE, e.C_NUMBER_MODE,
                e.C_BLOCK_COMMENT_MODE
              ]
            },
            e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE
    ...
    return {
      name: "HTML, XML",
          ...
          case_insensitive: !0, contains: [
            ...
            {begin : "<\\!\\[CDATA\\[", end : "\\]\\]>", relevance : 10}, n,
            ...
            },
            {
              ...
              contains : [
                {className : "name", begin : /[^\/><\s]+/, relevance : 0}, c
              ]
            }
          ]
    }
...
hljs.registerLanguage("php", function() {
  "use strict";
  return function(e) {
    var r = {begin : "\\$+[a-zA-Z_-ÿ][a-zA-Z0-9_-ÿ]*"}, t = {
      className : "meta",
      variants : [
    ...
    return {
      aliases: [ "php", "php3", "php4", "php5", "php6", "php7" ],
          case_insensitive: !0, keywords: i, contains: [
            e.HASH_COMMENT_MODE, e.COMMENT("//", "$", {contains : [ t ]}),
            e.COMMENT(
                "/\\*", "\\*/",
...
hljs.registerLanguage("swift", function() {
  ...
  return function(e) {
    ...
    return t.contains = [ r ], {
      name: "Swift", keywords: i, contains: [
        ...
        {className : "type", begin : "\\b[A-Z][\\wÀ-ʸ']*", relevance : 0}, r, {
          ...
          contains : [
            ...
            {begin : /</, end : />/}, {
              ...
              keywords : i,
              contains :
                  [ "self", r, a, e.C_BLOCK_COMMENT_MODE, {begin : ":"} ],
              illegal : /["']/
            }
          ],
          illegal : /\[|%/
        },
        {
          ...
          excludeEnd : !0,
          contains : [ e.inherit(
              e.TITLE_MODE, {begin : /[A-Za-z$_][\u00C0-\u02B80-9A-Za-z$_]*/}) ]
        },
        {
          className : "meta",
          begin :
  ...
  return function(n) {
    const e = {begin : "<", end : ">", subLanguage : "xml", relevance : 0},
          ...
          i = {
            ...
            contains : [],
            variants : [
              {begin : /_{2}/, end : /_{2}/}, {begin : /\*{2}/, end : /\*{2}/}
            ]
          },
          s = {
            className : "emphasis",
  ...
  return function(e) {
        ...
        u = {
          ...
          contains : [
            ...
            {begin : o, returnBegin : !0, contains : [ c ], relevance : 0}, {
              ...
              relevance : 0,
              contains : [
                e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE, a, s, r, {
                  begin : /\(/,
                  end : /\)/,
                  keywords : l,
                  relevance : 0,
                  contains : [
                    "self", e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE, a, s,
                    r
                  ]
                }
              ]
    ...
    return {
      aliases: [ "c", "cc", "h", "c++", "h++", "hpp", "hh", "hxx", "cxx" ],
          keywords: l, disableAutodetect: !0, illegal: "</",
          contains: [].concat(
              _, u, d,
              [
                i, {
...
hljs.registerLanguage("go", function() {
  ...
  return function(e) {
    ...
    return {
      name: "Go", aliases: [ "golang" ], keywords: n, illegal: "</", contains: [
        e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE, {
          className : "string",
          variants : [
            e.QUOTE_STRING_MODE, e.APOS_STRING_MODE, {begin : "`", end : "`"}
          ]
        },
        {
          className : "number",
          variants : [
            {begin : e.C_NUMBER_RE + "[i]", relevance : 1}, e.C_NUMBER_MODE
          ]
        },
        {begin : /:=/}, {
          className : "function",
...
hljs.registerLanguage("bash", function() {
  ...
  return function(e) {
    ...
    const a = {
      ...
      contains :
          [ {begin : /\d+#[0-9a-f]+/, className : "number"}, e.NUMBER_MODE, s ]
    };
    return {
      name: "Bash", aliases: [ "sh", "zsh" ], lexemes: /\b-?[a-z\._]+\b/,
          keywords: {
            keyword:
          ...
          contains: [
            ...
            a, e.HASH_COMMENT_MODE, t, {className : "", begin : /\\"/},
  ...
  return function(e) {
    var n = {
      ...
      literal : "true false null"
        ...
        a = {className : "symbol", begin : e.UNDERSCORE_IDENT_RE + "@"}, i = {
          className : "subst",
          begin : "\\${",
          end : "}",
    ...
    return d.variants[1].contains = [ o ], o.variants[1].contains = [ d ], {
      name: "Kotlin", aliases: [ "kt" ], keywords: n, contains: [
        e.COMMENT("/\\*\\*", "\\*/", {
          relevance : 0,
          contains : [ {className : "doctag", begin : "@[A-Za-z]+"} ]
        }),
...
hljs.registerLanguage("lua", function() {
  "use strict";
  return function(e) {
    var t = {begin : "\\[=*\\[", end : "\\]=*\\]", contains : [ "self" ]}, a = [
      e.COMMENT("--(?!\\[=*\\[)", "$"),
      e.COMMENT("--\\[=*\\[", "\\]=*\\]", {contains : [ t ], relevance : 10})
    ];
    return {
      name: "Lua", lexemes: e.UNDERSCORE_IDENT_RE, keywords: {
        literal: "true false nil",
        keyword:
...
hljs.registerLanguage("nginx", function() {
  ...
  return function(e) {
    ...
    return {
      name: "Nginx config", aliases: [ "nginxconf" ],
          contains:
              [
                e.HASH_COMMENT_MODE, {
                  begin : e.UNDERSCORE_IDENT_RE + "\\s+{",
...
hljs.registerLanguage("latex", function() {
  ...
  return function(e) {
    ...
    return {
      name: "LaTeX", aliases: [ "tex" ], contains: [
        n, {
          className : "formula",
          contains : [ n ],
          relevance : 0,
  ...
  return function(e) {
    ...
    return i.contains = [ r, l, a ], {
      name: "Python", aliases: [ "py", "gyp", "ipython" ], keywords: n,
          illegal: /(<\/|->|\?)|=>/, contains: [
            a, l, {beginKeywords : "if", relevance : 0}, r, e.HASH_COMMENT_MODE,
            {
              variants : [
          ...
          contains:
              [
                e.HASH_COMMENT_MODE, {
                  ...
                  contains : [
                    n, {className : "number", begin : ":\\d{1,5}"},
  ...
  return function(e) {
    var n = {
      ...
      built_in : "npm require console print module global window document"
        ...
        s = {className : "subst", begin : /#\{/, end : /}/, keywords : n}, a = [
    ...
    return {
      name: "CoffeeScript", aliases: [ "coffee", "cson", "iced" ], keywords: n,
          illegal: /\/\*/, contains: a.concat([
...
hljs.registerLanguage("perl", function() {
  ...
  return function(e) {
    var n = "getpwent getservent quotemeta msgrcv scalar kill dbmclose undef lc ma syswrite tr send umask sysopen shmwrite vec qx utime local oct semctl localtime readpipe do return format read sprintf dbmopen pop getpgrp not getpwnam rewinddir qq fileno qw endprotoent wait sethostent bless s|0 opendir continue each sleep endgrent shutdown dump chomp connect getsockname die socketpair close flock exists index shmget sub for endpwent redo lstat msgctl setpgrp abs exit select print ref gethostbyaddr unshift fcntl syscall goto getnetbyaddr join gmtime symlink semget splice x|0 getpeername recv log setsockopt cos last reverse gethostbyname getgrnam study formline endhostent times chop length gethostent getnetent pack getprotoent getservbyname rand mkdir pos chmod y|0 substr endnetent printf next open msgsnd readdir use unlink getsockopt getpriority rindex wantarray hex system getservbyport endservent int chr untie rmdir prototype tell listen fork shmread ucfirst setprotoent else sysseek link getgrgid shmctl waitpid unpack getnetbyname reset chdir grep split require caller lcfirst until warn while values shift telldir getpwuid my getprotobynumber delete and sort uc defined srand accept package seekdir getprotobyname semop our rename seek if q|0 chroot sysread setpwent no crypt getc chown sqrt write setnetent setpriority foreach tie sin msgget map stat getlogin unless elsif truncate exec keys glob tied closedir ioctl socket readlink eval xor readline binmode setservent eof ord bind alarm pipe atan2 getgrent exp time push setgrent gt lt or ne m|0 break given say state when",
        ...
        i = [ e.BACKSLASH_ESCAPE, t, r ], a = [
          r, e.HASH_COMMENT_MODE,
          e.COMMENT("^\\=\\w", "\\=cut", {endsWithParent : !0}), s, {
            className : "string",
            contains : i,
            variants : [
    ...
    return t.contains = a, s.contains = a, {
      name: "Perl", aliases: [ "pl", "pm" ], lexemes: /[\w\.]+/, keywords: n,
          contains: a
    }
  }
}());
    ...
    return {
      name: "Rust", aliases: [ "rs" ], keywords: {
        ...
        built_in: t
          ...
          lexemes: e.IDENT_RE + "!?", illegal: "</", contains: [
...
hljs.registerLanguage("makefile", function() {
  ...
  return function(e) {
    ...
    return {
      name: "Makefile", aliases: [ "mk", "mak" ],
          keywords:
              "define endef undefine ifdef ifndef ifeq ifneq else endif include -include sinclude override export unexport private vpath",
          lexemes: /[\w-]+/, contains: [
            e.HASH_COMMENT_MODE, i, n, a, s, {
              className : "meta",
              begin : /^\.PHONY:/,
              end : /$/,
...
hljs.registerLanguage("ini", function() {
  ...
  return function(e) {
    ...
    return {
      name: "TOML, also INI", aliases: [ "toml" ], case_insensitive: !0,
          illegal: /\S/, contains: [
            a, {className : "section", begin : /\[+/, end : /\]+/}, {
              begin : /^[a-z0-9\[\]_\.-]+(?=\s*=\s*)/,
              className : "attr",
              starts : {
                end : /$/,
...
hljs.registerLanguage("ruby", function() {
  ...
  return function(e) {
    ...
    return {
      name: "Ruby", aliases: [ "rb", "gemspec", "podspec", "thor", "irb" ],
          keywords: a, illegal: /\/\*/, contains: r.concat(g).concat(d)
    }
  }
}());
hljs.registerLanguage("yaml", function() {
  ...
  return function(e) {
    ...
    return {
      name: "YAML", case_insensitive: !0, aliases: [ "yml", "YAML" ], contains: [
        {
          className : "attr",
          variants : [
            {begin : "\\w[\\w :\\/.-]*:(?=[ \t]|$)"},
      ...
      name: "SQL", case_insensitive: !0, illegal: /[<>{}*]/, contains: [
        {
          ...
          contains : [
            ...
            {className : "string", begin : "`", end : "`"}, e.C_NUMBER_MODE,
...
hljs.registerLanguage("typescript", function() {
  ...
  return function(e) {
    var n = {
      ...
      built_in :
        ...
        r = {className : "meta", begin : "@[A-Za-z$_][0-9A-Za-z$_]*"}, a = {
          ...
          keywords : n,
          contains :
              [ "self", e.QUOTE_STRING_MODE, e.APOS_STRING_MODE, e.NUMBER_MODE ]
        },
        t = {
          className : "params",
          begin : /\(/,
        ...
        s = {
          className : "number",
          variants : [
            {begin : "\\b(0[bB][01]+)n?"}, {begin : "\\b(0[oO][0-7]+)n?"},
    ...
    return i.contains =
               [
                 e.APOS_STRING_MODE, e.QUOTE_STRING_MODE, o, c, E, s,
                 e.REGEXP_MODE
               ],
    {
      name: "TypeScript", aliases: [ "ts" ], keywords: n, contains: [
        {className : "meta", begin : /^\s*['"]use strict['"]/},
        e.APOS_STRING_MODE, e.QUOTE_STRING_MODE, o, c, E, e.C_LINE_COMMENT_MODE,
        e.C_BLOCK_COMMENT_MODE, s, {
          begin : "(" + e.RE_STARTERS_RE + "|\\b(case|return|throw)\\b)\\s*",
          keywords : "return throw case",
          contains : [
            e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE, e.REGEXP_MODE, {
              className : "function",
              begin : "(\\(.*?\\)|" + e.IDENT_RE + ")\\s*=>",
              returnBegin : !0,
              end : "\\s*=>",
              contains : [ {
                ...
                variants : [
                  {begin : e.IDENT_RE}, {begin : /\(\s*\)/}, {
                    ...
                    keywords : n,
                    contains : [
                      "self", e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE
                    ]
                  }
                ]
              } ]
        ...
        },
        {
          ...
          contains : [
            "self",
            e.inherit(e.TITLE_MODE, {begin : "[A-Za-z$_][0-9A-Za-z$_]*"}), t
          ],
          illegal : /%/,
          relevance : 0
        },
...
hljs.registerLanguage("json", function() {
  ...
  return function(n) {
    var e = {literal : "true false null"},
        ...
        t = [ n.QUOTE_STRING_MODE, n.C_NUMBER_MODE ], a = {
          end : ",",
          endsWithParent : !0,
          excludeEnd : !0,
          contains : t,
...
hljs.registerLanguage("scss", function() {
  ...
  return function(e) {
    ...
    return e.CSS_NUMBER_MODE, e.QUOTE_STRING_MODE, e.APOS_STRING_MODE,
           e.C_BLOCK_COMMENT_MODE, {
      name: "SCSS", case_insensitive: !0, illegal: "[=/|']", contains: [
        e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE,
        ...
        },
        {
          ...
          contains : [
            t, i, e.CSS_NUMBER_MODE, e.QUOTE_STRING_MODE, e.APOS_STRING_MODE,
        ...
        },
        {
          ...
          contains : [
            {begin : "@[a-z-]+", className : "keyword"}, t, e.QUOTE_STRING_MODE,
            e.APOS_STRING_MODE, i, e.CSS_NUMBER_MODE
          ]
        }
      ]
    }
  ...
  return function(e) {
    return {
      name: "Dockerfile", aliases: [ "docker" ], case_insensitive: !0,
          ...
          contains:
              [
                e.HASH_COMMENT_MODE, e.APOS_STRING_MODE, e.QUOTE_STRING_MODE,
                e.NUMBER_MODE, {
                  beginKeywords :
...
hljs.registerLanguage("objectivec", function() {
  ...
  return function(e) {
    ...
    return {
      name: "Objective-C", aliases: [ "mm", "objc", "obj-c" ], keywords: {
        keyword:
...
hljs.registerLanguage("properties", function() {
  ...
  return function(e) {
    ...
    return {
      name: ".properties", case_insensitive: !0, illegal: /\S/, contains: [
        e.COMMENT("^\\s*[!#]", "$"), {
          begin : "([^\\\\\\W:= \\t\\f\\n]|\\\\.)+" + t,
          returnBegin : !0,
          contains : [ {
...
hljs.registerLanguage("less", function() {
  ...
  return function(e) {
    ...
    s.push(e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE, t("'"), t('"'),
           e.CSS_NUMBER_MODE, {
             begin : "(url|data-uri)\\(",
             starts : {className : "string", end : "[\\)\\n]", excludeEnd : !0}
           },
           r("number", "#[0-9A-Fa-f]+\\b"), i, r("variable", "@@?[\\w-]+", 10),
           r("variable", "@{[\\w-]+}"), r("built_in", "~?`[^`]*?`"), {
             className : "attribute",
             begin : "[\\w-]+\\s*:",
             end : ":",
             returnBegin : !0,
    ...
    var c = s.concat({begin : "{", end : "}", contains : a}), l = {
      ...
      contains : [ {beginKeywords : "and not"} ].concat(s)
        ...
        d = {
          className : "variable",
          variants : [
            {begin : "@[\\w-]+\\s*:", relevance : 15}, {begin : "@[\\w-]+"}
          ],
          starts : {end : "[;}]", returnEnd : !0, contains : c}
        },
        b = {
          variants : [
            {begin : "[\\.#:&\\[>]", end : "[;{}]"}, {begin : n, end : "{"}
          ],
          returnBegin : !0,
          returnEnd : !0,
          illegal : "[<='$\"]",
          relevance : 0,
          contains : [
            e.C_LINE_COMMENT_MODE, e.C_BLOCK_COMMENT_MODE, l,
            r("keyword", "all\\b"), r("variable", "@{[\\w-]+}"),
            r("selector-tag", n + "%?", 0), r("selector-id", "#" + n),
            r("selector-class", "\\." + n, 0), r("selector-tag", "&", 0),
...
hljs.registerLanguage("css", function() {
  ...
  return function(e) {
      ...
      contains : [ {
        ...
        starts : {
          ...
          contains : [
            ...
            e.CSS_NUMBER_MODE, e.QUOTE_STRING_MODE, e.APOS_STRING_MODE,
            e.C_BLOCK_COMMENT_MODE,
    ...
    return {
      name: "CSS", case_insensitive: !0, illegal: /[=\/|'\$]/, contains: [
        e.C_BLOCK_COMMENT_MODE,
...
hljs.registerLanguage("javascript", function() {
  ...
  return function(e) {
    ...
    i.contains =
        [ e.APOS_STRING_MODE, e.QUOTE_STRING_MODE, t, c, o, r, e.REGEXP_MODE ];
